...
<div class="container" style="max-width: 600px;">
    ...
    <div class="mb-3">
        <a href="/capitan/tienda?id=<%=idTienda%>" class="btn btn-secondary">Volver a Detalles</a>
    </div>
    ...
    <form method="POST" action="/capitan/registrarIncidencia" class="mt-3">
        ...
        <div class="mt-3" style="display: flex; gap: 10px; justify-content: center;">
            ...
            <a href="/capitan/tienda?id=<%=idTienda%>" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
