...
<div class="container">
    ...
    <%if(turnos != null && turnos.size() > 0){%>
        <table border="1">
            ...
            <tr>
                <td>
                    <strong><a href="/resp-tienda/detalles-voluntario?id=<%=turno.getIdVoluntario().getId()%>&tienda=<%=tienda.getId()%>" style="color: #0066cc; text-decoration: underline;"><%=turno.getIdVoluntario().getNombre()%></a></strong>
                </td>
    ...
    <div style="margin-top: 30px;">
        <a href="/resp-tienda/tienda?id=<%=tienda.getId()%>">Ver Detalles de Turnos</a>
    </div>
</div>
