...
%>
    ...
    <h2 class="mt-3">Mi Tienda Asignada</h2>
    ...
    <%if(tiendas != null && tiendas.size() > 0){%>
        <table class="table-striped">
            ...
            <tr>
                ...
                <td>
                    <a href="/resp-tienda/tienda?id=<%=tienda.getId()%>" class="btn btn-primary btn-sm">Ver Detalles</a>
                    <a href="/resp-tienda/voluntarios?id=<%=tienda.getId()%>" class="btn btn-info btn-sm">Ver Voluntarios</a>
                </td>
            </tr>
            <%}%>
            </tbody>
