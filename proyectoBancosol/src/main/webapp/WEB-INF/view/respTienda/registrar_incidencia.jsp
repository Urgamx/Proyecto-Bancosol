...
<div class="container">
    <div class="back-link">
        <a href="/resp-tienda/tienda?id=<%=idTienda%>">Volver a Detalles</a>
    </div>
    ...
    <form method="POST" action="/resp-tienda/registrarIncidencia">
        <div class="info-box">
        ...
        <div class="button-group">
            ...
            <a href="/resp-tienda/tienda?id=<%=idTienda%>" class="btn btn-cancel">Cancelar</a>
        </div>
    </form>
</div>
