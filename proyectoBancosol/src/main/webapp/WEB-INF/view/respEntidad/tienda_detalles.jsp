...
%>
    ...
    <%if(turnos != null && turnos.size() > 0){%>
        <table class="table-striped">
            ...
            <tr>
                <td><a href="/resp-entidad/detalles-voluntario?id=<%=turno.getVoluntario().getId()%>&tienda=<%=tienda.getId()%>"><%=turno.getVoluntario().getNombre()%></a></td>
                ...
                <td>
                    <a href="/resp-entidad/detalles-voluntario?id=<%=turno.getVoluntario().getId()%>&tienda=<%=tienda.getId()%>" class="btn btn-primary btn-sm">Ver Detalles</a>
                    <%if(turno.getDescripcionIncidencia() == null || turno.getDescripcionIncidencia().isEmpty()){%>
