        ...
        <table class="table-striped mt-3">
            <thead>
                <tr>
                    <th>VOLUNTARIO</th>
                    <th>CAMPAÑA</th>
                    <%-- Unificamos Día, Franja y Horario en una sola columna limpia --%>
                    <th>HORARIO</th>
                    <th>ESTADO</th>
                </tr>
            </thead>
            ...
            <tr>
                <td>
                    <a href="/resp-entidad/detalles-voluntario?id=<%=turno.getVoluntario().getId()%>&tienda=<%=tienda.getId()%>"><strong><%=turno.getVoluntario().getNombre()%></strong></a>
                </td>
                
                <%-- Usamos el nombre de la campaña que añadimos antes al DTO --%>
                <td><%=turno.getNombreCampana()%></td>
                
                <%-- Usamos nuestro horario unificado --%>
