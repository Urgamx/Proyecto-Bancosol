...
ALTER TABLE CAMPANA ADD CONSTRAINT FK_CAMPANA_USUARIO FOREIGN KEY (id_usuario) REFERENCES USUARIO (id_usuario);
...
ALTER TABLE ASIGNACION_TURNOS ADD CONSTRAINT FKASIGNACION_CAMPANA FOREIGN KEY (id_campana) REFERENCES CAMPANA (id_campana);